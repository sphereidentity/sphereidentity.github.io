...
jQuery(document).ready(function(n){n("#block-sphere-main-menu .menu li").hover(function(){n(window).width()>768&&n(this).find(".sub-menu").toggle()}),n(".menu-toggle").on("click",function(){n("#block-sphere-main-menu .menu").slideToggle("slow"),n("#block-sphere-main-menu .menu li .sub-menu").parent("li").addClass("has-submenu")}),n("#block-sphere-main-menu .menu li").on("click",function(){n(this).find(".sub-menu").slideToggle("slow",function(){})});var e=Drupal.dialog(n(".hidden-form"),{autoOpen:!0,width:700,classes:{"ui-dialog":"homepage-form-dialog"},title:"SIGN-UP FOR BETA",beforeClose:function(e,o){n("body").css("position","relative")}});n(".hidden-form-cta").on("click",function(o){o.preventDefault(),e.showModal(),n(window).width()<768&&n("body").css("position","fixed")}),n('a[href="#products"]').on("click",function(e){n("html, body").animate({scrollTop:n(".homepage-content").offset().top-135},1200)}),n('a[href="#launch-date"]').on("click",function(e){n("html, body").animate({scrollTop:n(".launching-mid").offset().top-160},1200)}),screen.width<768&&n("ul.menu a").click(function(){n("ul.menu").hide()})});;
/**
 * @file
